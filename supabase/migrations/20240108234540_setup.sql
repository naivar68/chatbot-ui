...
AS $$
DECLARE
  project_url TEXT := 'https://kddelktfayreunixvjug.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImtkZGVsa3RmYXlyZXVuaXh2anVnIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxNTc0MTU1MiwiZXhwIjoyMDMxMzE3NTUyfQ.PQWvUl_aAzyNFiqH1vQDJcXp3sdoLbaxv-JgxAXyaTI'; -- full access needed for http request to storage
